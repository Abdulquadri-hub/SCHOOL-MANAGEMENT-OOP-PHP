...
<?php $this->view('includes/nav'); ?>
    ...
    <?php $this->view('includes/crumbs',['crumbs'=>$crumbs]); ?>
        ...
        <div class="row">
            ...
            <center class="row">
                <h6 class="col">
                    Class : <a href="<?=ROOT?>/single_class/<?=$row->class_id?>">
                            <?=esc(ucwords($row->class->class))?>
                            </a>
                </h6>
                <h6 class="col">
                    Student : <a href="<?=ROOT?>/profile/<?=$student->user_id?>">
                                <?=esc(ucwords($student->firstname))?> <?=esc(ucwords($student->lastname))?>
                            </a>
                </h6>
            </center>
        ...
        switch ($page_tab) {
            case 'view':
                # code...
                include(views_path('marked-single-test-tab-view'));
                break;
