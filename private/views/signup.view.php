<?php $this->view('includes/header'); ?>
    ...
    <div class="container-fluid">
        ...
        <input class="my-2 form-control" value="<?=get_var('firstname')?>" type="text" name="firstname" placeholder="First-Name" id="">
        <input class="my-2 form-control" value="<?=get_var('lastname')?>" type="text" name="lastname" placeholder="Last-Name" id="">
        <input class="my-2 form-control" value="<?=get_var('email')?>" type="email" name="email" placeholder="E-mail" id="">
        ...
        <?php if($mode == 'students'):?>
            <input class="form-control" type="text" value="student" name="rank">
        <?php else:?>
